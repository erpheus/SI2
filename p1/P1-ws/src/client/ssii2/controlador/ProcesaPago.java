...
private void printAddresses(HttpServletRequest request, HttpServletResponse response) throws SocketException {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, request.getServletContext().getInitParameter("service-url") ); 
		...
		if (pago == null) {
			...
			dao.setDebug(isdebug? "true": "false");
